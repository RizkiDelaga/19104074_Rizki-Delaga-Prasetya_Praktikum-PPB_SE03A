package com.rizkidelagaprasetya_19104074.praktikum6

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.recyclerview.widget.LinearLayoutManager
import com.rizkidelagaprasetya_19104074.praktikum6.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRecyclerList() {
        binding.apply {
            ...
            val lisMyDataAdapter = MainAdapter(this@MainActivity, list)
            rv_pariwisata.adapter = lisMyDataAdapter
        }
    }
